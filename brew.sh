...
pause_for "Open Parallels Desktop and activate it with your license key."
pause_for "Optional: to SSH into this Mac, turn on Remote Login (System Settings -> General -> Sharing)."
